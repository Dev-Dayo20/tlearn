    ...
    <section className="py-20 bg-secondary relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p
            className="text-lg md:text-xl text-black/50 mb-10 animate-fade-in"
            style={{ animationDelay: "0.1s" }}
          >
            Join 1000+ students already transforming their screen time into
            academic excellence. Try TLearn free for 7 days - no credit card
            required.
          </p>

          <div
            className="bg-card rounded-2xl p-8 shadow-2xl max-w-xl mx-auto animate-slide-up"
          ...
          >
            <form className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                🎁 <strong>Free 7-day trial</strong> • No credit card required •
                Cancel anytime
              </p>
            </form>
          </div>
