...
const SocialProof = () => {
  ...
  const testimonials = [
    {
      quote:
        "TLearn has completely transformed how our students engage with learning. The curriculum alignment is perfect, and the pricing makes it accessible to all families.",
      author: "Mrs. Adebayo",
      role: "Principal, Lagos Model Secondary School",
    },
    {
      quote:
        "My daughter now asks to use her tablet for TLearn instead of games. Her grades have improved significantly in just one term!",
      author: "Mr. Okonkwo",
      role: "Parent of SSS 2 Student",
    },
    {
      quote:
        "As a teacher, I love that I can track my students' progress and upload supplementary materials. It's a game-changer for education.",
      author: "Miss Chioma",
