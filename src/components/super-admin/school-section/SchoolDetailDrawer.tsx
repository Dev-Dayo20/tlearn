...
export function SchoolDetailDrawer({
  ...
  const handledrawerDeleteDialog = () => {
    setDeleteDrawerDialog(true);
  };
  ...
  return (
    <>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Button
                  ...
                  onClick={() => handledrawerDeleteDialog()}
                >
      ...
      <AlertDialogue
        isOpen={deleteDrawerDialog}
        onOpenChange={setDeleteDrawerDialog}
        onConfirm={handleDeleteConfirm}
        title="Are you sure you want to delete this school?"
        description={`This will permanently delete ${school.name} and all associated data including users, classes, and videos. This action cannot be undone.`}
        confirmText="Delete"
        cancelText="Cancel"
        disabled={isDeleting}
        type="destructive"
